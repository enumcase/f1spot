...
export const monacoCircuitData: Circuit = {
  ...
  mapImage: '/images/circuits/maps/monaco-map-placeholder.png',
  seatAreas: [
    {
      id: 'k-grandstand',
      name: 'Grandstand K',
      ...
      viewImages: ['/images/seats/monaco/k-grandstand-view.jpg'],
    ...
    },
    {
      ...
      viewImages: ['/images/seats/monaco/t-grandstand-view.jpg'],
