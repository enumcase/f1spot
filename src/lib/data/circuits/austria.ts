...
export const austriaCircuitData: Circuit = {
  ...
  mapImage: '/images/circuits/maps/austria-map-placeholder.png',
  seatAreas: [
    {
      ...
      viewImages: ['/images/seats/austria/rb-grandstand-view.jpg'],
    ...
    },
    {
      ...
      viewImages: ['/images/seats/austria/steiermark-view.jpg'],
