...
export const britainCircuitData: Circuit = {
  ...
  mapImage: getCircuitMapUrl('britain-map.png'),
  seatAreas: [
    {
      ...
      viewImages: [getSeatViewImageUrl('britain', 'woodcote-view.jpg')],
    ...
    },
    {
      ...
      viewImages: [getSeatViewImageUrl('britain', 'club-corner-view.jpg')],
