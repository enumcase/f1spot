...
export const canadaCircuitData: Circuit = {
  ...
  mapImage: getCircuitMapUrl('canada-map.png'),
  seatAreas: [
    {
      id: 'grandstand-11',
      name: 'Grandstand 11',
      ...
      viewImages: [getSeatViewImageUrl('canada', 'gs11-view.jpg')],
    ...
    },
    {
      ...
      viewImages: [getSeatViewImageUrl('canada', 'ls-grandstand-view.jpg')],
